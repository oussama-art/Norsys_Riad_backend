 ...
 */
final class Version20240806081958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD user_id INT DEFAULT NULL, DROP riad_id, CHANGE total_price total_price NUMERIC(10, 2) DEFAULT NULL, CHANGE room_id room_id INT DEFAULT NULL');
